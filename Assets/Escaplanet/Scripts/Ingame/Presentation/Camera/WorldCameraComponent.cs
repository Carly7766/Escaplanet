...
{
    public class WorldCameraComponent : MonoBehaviour, IWorldVirtualCameraCore
    {
        #region Unity Fields
        ...
        {
            get => new(new Root.Common.ValueObject.Vector3(_transform.localPosition.x, _transform.localPosition.y, _transform.localPosition.z),
